...
const Hero = () => {
  const handleScroll = () => {
    ...
    document.getElementById("rocket").style.marginTop = `${window.scrollY * -1}px`;
    document.getElementById("rocks").style.marginTop = `${window.scrollY * -1}px`;
    document.getElementById("text").style.marginLeft = `${window.scrollY * 1}px`;
  };
